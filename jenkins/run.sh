...
echo "add note to jenkins script to init.groovy.d/"
cp /usr/share/jenkins/ref/init.groovy.d/addNodeToJenkins.groovy /var/jenkins_home/init.groovy.d/addNodeToJenkins.groovy
...
echo "Get JAR"
curl -X GET $JENKINS_API/jnlpJars/agent.jar
